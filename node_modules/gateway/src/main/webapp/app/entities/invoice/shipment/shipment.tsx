...
export const Shipment = () => {
  ...
  const shipmentList = useAppSelector(state => state.gateway.shipment.entities);
  const loading = useAppSelector(state => state.gateway.shipment.loading);
  const totalItems = useAppSelector(state => state.gateway.shipment.totalItems);
      ...
      <h2 id="shipment-heading" data-cy="ShipmentHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="gatewayApp.invoiceShipment.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/shipment/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gatewayApp.invoiceShipment.home.createLabel">Create new Shipment</Translate>
          </Link>
        </div>
      </h2>
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="gatewayApp.invoiceShipment.id">ID</Translate>{' '}
