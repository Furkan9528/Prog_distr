...
export const ShipmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.invoiceShipment.delete.question">
        <Translate contentKey="gatewayApp.invoiceShipment.delete.question" interpolate={{ id: shipmentEntity.id }}>
