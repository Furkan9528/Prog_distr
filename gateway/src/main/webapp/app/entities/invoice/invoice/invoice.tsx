...
export const Invoice = () => {
  ...
  const invoiceList = useAppSelector(state => state.gateway.invoice.entities);
  const loading = useAppSelector(state => state.gateway.invoice.loading);
  const totalItems = useAppSelector(state => state.gateway.invoice.totalItems);
      ...
      <h2 id="invoice-heading" data-cy="InvoiceHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="gatewayApp.invoiceInvoice.home.refreshListLabel">Refresh List</Translate>
          </Button>
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="gatewayApp.invoiceInvoice.id">ID</Translate>{' '}
